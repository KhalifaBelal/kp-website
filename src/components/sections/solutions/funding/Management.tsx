  ...
  return (
    <KPRow flexDirection="col" alignItems="start">
      ...
      <KPParagraph textColor="black">
        ...
        With Khalifa Partners, you can concentrate on strategic aspects while we
        handle the financial side. Take advantage of shared company management
        and unleash your venture&apos;s true potential.
      </KPParagraph>
    </KPRow>
  );
}
