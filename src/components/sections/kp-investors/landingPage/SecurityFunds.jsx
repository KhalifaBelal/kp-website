      ...
      <KPRow>
        ...
        >
          ...
          <KPParagraph className="text-zinc-700">
            ...
            <br />
            <br />
            With our Security Fund in place, you can invest with complete peace
            of mind. In the rare event that an investment does not meet its
            expected results, we guarantee to refund your entire investment
            amount. This commitment ensures that you face no financial risk,
            giving you the freedom to explore investment opportunities with
            confidence.
            <br />
            <br />
