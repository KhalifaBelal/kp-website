...
const PORTFOLIO_DATA: {
  ...
  website?: string;
    ...
    {
      name: "Salespects",
      description: "Salespects is a SaaS solution and the first CRM system exclusively for financial advisors in Germany. Targeting a market of over 300,000 potential clients, Salespects has been in development for over two years and will launch in 2024.",
      twColor: "",
