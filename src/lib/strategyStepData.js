export const strategyStepData = [
  ...
  {
    title: "Step 3: Offer",
    text: "If you successfully pass the evaluation by our Board of Directors, we extend a partnership offer to you. As a General Manager, your main task will be managing the day-to-day business operations and effectively communicating the company's message to the outside world, essentially acting as a CEO. In addition, you will have the opportunity to become an equity partner, aligning your success with the growth and prosperity of the company.",
    model: 2,
  },
];
